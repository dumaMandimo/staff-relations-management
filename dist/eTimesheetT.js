...
var tasksRef = (0, _firebaseDatabase.ref)(database, 'tasks');
...
function calculateDuration(startTime, endTime) {
  ...
  var diff = (end - start) / 1000; // in seconds
...
function addTask() {
  ...
  var employeeEmail = document.querySelector("#employeeEmail").value;
  ...
  var status = "";
  var inProgressRadio = document.querySelector("#status2");
  var completedRadio = document.querySelector("#status3");
  ...
  (0, _firebaseDatabase.push)(tasksRef, {
...
function deleteTask(taskId) {
  (0, _firebaseDatabase.remove)((0, _firebaseDatabase.ref)(database, "tasks/".concat(taskId)));
...
function loadTasksFromFirebase(email) {
  ...
  (0, _firebaseDatabase.onValue)(tasksRef, function (snapshot) {
    ...
    if (tasks) {
      Object.keys(tasks).forEach(function (taskId) {
        ...
        if (task.employeeEmail === email) {
          ...
          newRow.innerHTML = "\n                        <td>".concat(task.employeeName, "</td>\n                        <td>").concat(task.employeeEmail, "</td>\n                        <td>").concat(task.task, "</td>\n                        <td>").concat(task.date, "</td>\n                        <td>").concat(task.duration, "</td>\n                        <td>").concat(task.status, "</td>\n                        <td>\n                            <button class=\"btn btn-warning btn-sm edit\" data-id=\"").concat(taskId, "\">Edit</button>\n                            <button class=\"btn btn-danger btn-sm delete\" data-id=\"").concat(taskId, "\">Delete</button>\n                        </td>\n                    ");
...
document.querySelector("#retrieveTimesheetForm").addEventListener("submit", /*#__PURE__*/function () {
...
document.addEventListener("click", function (e) {
  if (e.target.classList.contains("edit")) {
    ...
    tasksRef.child(taskId).once("value", function (snapshot) {
